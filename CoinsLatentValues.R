...
load("stanfits/mean_baseline_weight")
load("stanfits/mean_stay_weight")
load("stanfits/mean_dist_weight")
load("stanfits/mean_time_weight")
load("stanfits/mean_numb_weight")
...
save(s_baseline, file = "s_baseline")
