...
dat_demographics$Gender <- as.numeric( ifelse(dat_demographics$Gender == "Männlich", 1, 2) )
dat_demographics$Minecraft <- as.numeric( unlist( sapply(1:160, function(i){
  if (dat_demographics$Minecraft[i] == "Ja")          return(1)
  if (dat_demographics$Minecraft[i] == "Weiß Nicht") return(2)
...
dat_demographics_solo$Gender <- as.numeric( ifelse(dat_demographics_solo$Gender == "Männlich", 1, 2) )


dat_demographics_solo$Minecraft[dat_demographics_solo$Minecraft == "Ja"]            <- 1
dat_demographics_solo$Minecraft[dat_demographics_solo$Minecraft == "Weiß Nicht"]   <- 2
